...
namespace Ztop.Todo.Manager
{
    public class CityManager:ManagerBase
    {
        ...
        {
            return DB.Citys.Any(e => e.Name == name && e.Code == code);
        ...
        public List<City> Search(CityParameter parameter)
        {
            var query = DB.Citys.AsQueryable();
            if (parameter.Rank.HasValue)
            {
                query = query.Where(e => e.Rank == parameter.Rank.Value);
            }
            if (parameter.PCID.HasValue)
            {
                query = query.Where(e => e.PCID == parameter.PCID.Value);
            }
